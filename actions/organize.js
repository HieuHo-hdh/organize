...
export const actionTypes = {
    ...
    SEARCH_ORGANIZE: defineAction('SEARCH_ORGANIZE'),
}

export const actions = {
    getOrganize: createActionWithLoading(actionTypes.GET_ORGANIZE),
    ...
    searchOrganize: createAction(actionTypes.SEARCH_ORGANIZE),
}
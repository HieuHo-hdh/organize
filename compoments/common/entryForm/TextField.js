...
class TextField extends BaseField {
    ...
    getMinLengthMsg() {
        ...
        return minLengthMsg || `This field cannot be shorter than ${minLength} characters`;
    }
    ...
    getTextFieldRules() {
        ...
        if(type === 'email') {
            rules.push({
                type,
                message: invalidEmailMsg || 'Invalid email format!'
            })
        }
            ...
            >
                {
                    type === 'textarea'
                    ?
                    <TextArea placeholder={this.getPlaceHolder()} disabled={disabled} onBlur={onBlur}/>
                    :
                    <Input size={size} placeholder={this.getPlaceHolder()} disabled={disabled} type={type} onBlur={onBlur}/>
                } 
            </Form.Item>
        )
    }

    ...
    checkPermission(pathname){
        Object.keys(sitePathConfig).forEach(key => {
            if(sitePathConfig[key].path === pathname) {
                if(sitePathConfig[key].permissions && sitePathConfig[key].permissions
                    .some(menuPermission => this.userData.permissions.indexOf(menuPermission) < 0)) {
                    ...
                    <Layout style={{ marginLeft: navSidercollapsed ? LayoutConfigs.NAV_WIDTH_COLLAPSED : LayoutConfigs.NAV_WIDTH_EXPANDED }}>
                        ...
                        <Content className="app-content">
                            ...
                            <Footer className="app-footer">
                                Copyright © HQ Tech, All Rights Reserved.
                            </Footer>
                        </Content>
                    </Layout>
                </Layout>

...
import logoUrl from '../../../assets/images/hqtech.png';
    ...
    render() {
            ...
            if(navMenu.children) {
                navMenu.children = navMenu.children.filter(navMenuChild => {
                    if(navMenuChild.permissions)
                        return navMenuChild.permissions.some(menuPermission => userData.permissions.indexOf(menuPermission) > -1);
                    return true;
                });
                ...
                return navMenu.permissions.some(menuPermission => userData.permissions.indexOf(menuPermission) > -1);
            }
            return true;
        });
        ...
        return (
            <Sider
                ...
                >
                <div className={navSidercollapsed ? 'logo logo__collapsed' : 'logo logo__expanded'}>
